...
import { Step3Talhoes } from './components/Step3Talhoes'
...
export default function SimuladorPage() {
  ...
  const nextStep = async () => {
    ...
    if (currentStep === 3) fieldsToValidate = ['talhoes']
      ...
      <FormProvider {...methods}>
        ...
        >
          <div className="flex-1 overflow-auto custom-scrollbar flex flex-col pt-0 pb-0">
            ...
            {currentStep === 2 && <Step2Area onNext={nextStep} onPrev={prevStep} onMapEditToggle={(active) => setIsMapEditMode(active)} onLocationSelect={handleLocationSelect} onGeoJsonSelect={handleGeoJsonSelect} />}
            {currentStep === 3 && <Step3Talhoes onNext={nextStep} onPrev={prevStep} onMapEditToggle={(active) => setIsMapEditMode(active)} />}
